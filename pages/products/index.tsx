...
import { alertPopup, useAppDispatch, useAppSelector } from "../../configs";
...
import { KEY_PRODUCTS } from './utility';
...
const Products = ({
  ...
  const handleAddToCart = (item:ProductsProps) =>{
    let products  = JSON.parse(localStorage[KEY_PRODUCTS] || "[]")
          ...
          <Grid container item xs={6} sm={3} md={3} lg={3} key={index}>
            <Card sx={{ maxWidth: 345 }}>
              ...
              <CardActions disableSpacing>
                ...
                <IconButton aria-label="share" onClick={()=>handleAddToCart(_elt)}>
                  <AddShoppingCartIcon />
                </IconButton>
                <ExpandMore
                  expand={expanded}
